...
1. Vi ved at når pi falder vil dette resultere i en stigning i "u" da en større andel af indkomsten flyttesfra profit til løn --> hvor der ikke opspares af lønnen. 

2. Dette resultere i at vi ud fra real-løn funktionen kan se en stigning i real-lønnen. 

3. Den højere utilization rate hæver profit raten --> vi bruger en større andel af vores kapital og kan derfor lave større afkast på kapital. --> vi kan se at r funktionen stiger når u stiger. --> her stiger u mere end pi falder. 
...
Vi ved i hvertfald at når $u^*$ stiger vil $l$ også stige. 
