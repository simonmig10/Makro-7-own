...
if we look at the expression for the real wage $w^*= 1- \pi/\alpha_0$ a decrease in $\alpha_0$ will increase the real wage. 
...
1. central banknen køber aktiver finansieret af broad money og en tilsvarende stigning i centralbankens reserver 
2. The seller of the asset vil nu holde de nyskabte deposits "in place of goverment bonds" (forstår ik helt)
