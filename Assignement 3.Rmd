...
**C Write out and analyse the three meain equations in the canoniacal new Keynesian model**
...
**A** What is the interpretation of the parameter β ? What are the implications of β being bigger, equal or smaller than 1?


**B** Plot the loss function in the y − π space (you can put y in the horizontal axis and π in the vertical, such that the graph is the same that we use when plotting the Philips curve) for the cases where β > 1, β = 1 and β < 1.
