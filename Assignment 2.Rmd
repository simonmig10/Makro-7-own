...
- How does the relative demand for leisure $\frac{(1-l_2)}{(1-l_1)}$ depend on the relative wage $\frac{w_1}{w_2}$. 

- How does the relative demand for leisure $\frac{(1-l_2)}{(1-l_1)}$ depend on the interest rate (r)?
