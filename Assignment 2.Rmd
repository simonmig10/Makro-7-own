...
I og med vi ved at det er den case vi har må G_a^* være stejlere end G_k^* --> se den case. 

Vi kan vise hvordan vi når frem til de to gange vi tagr log og differentiere med tid. 
...
Beta er elasticiteten på output når der allokeres 1 mere enhed af kapital i R&D --> så hvor mget mere output stiger. 

Vi kan se at i det case hvis der ingen population growth er vil der ingen vækst rate være. 
...
We use the constant -relative-risk -aversion instantanius utility function --> Står side 52
...
indkomst og substitutions effekten vil gå med hinanden ved en stigning i indkomst --> grundet kun 1 periode. --> noget med at når man har den løn man skal bruge til at dække sit forbrug --> vil man være ligelad med at den stiger da man bare skal have nok til at dække sit forbrug i den periode. 
...
lige kig på den her igen --> forkert
...
Vi kan ik fjerne gamma men flyt den udenfor og så bytter de plads 
