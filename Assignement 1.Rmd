...
whereas period 2 consumption is given by: C2t+1 = St(1 + r) + (1 + n)T . Note that n represents population growth. Take the wage w and interest rate r as exogenous and solve the following:
