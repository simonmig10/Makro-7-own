...
Indsæt forklaring fra stationær

Kan bare ikke se på grafen hvordan $k$ stiger for hvert niveau af $c$ 

- Den sidste effekt med at k stiger for hvert niveau af c er kun for store værdier af k --> me for små værdier af k vil det være faldende? måske spørge Mikael. 
...
Her er udviklingen i c fast derfor må den nye forskel fra break even investeringen gå over i mere investering og i kapital apperatet. 
...
Skrive svar ind fra skrift 

(a high value
of $\theta$ indicates that the household prefers a relative smooth consumption prole while
a small value of $\theta$ indicates that the household is not harmed signicantly by a more
...
```{r}
#knitr::include_graphics(rep("figure 2.8.png", 1), dpi = 150)
```
